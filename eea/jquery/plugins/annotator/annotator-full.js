...
Range.nodeFromXPath = function(xpath, root, matchText, offset) {
  ...
  if (node && matchText && $(node).text().toLowerCase().indexOf(matchText) === -1) {
    node = null;
  }
  if (!node && matchText) {
...
Range.BrowserRange = (function() {
  ...
  BrowserRange.prototype.normalize = function(root, matchText) {
    ...
    } else if (matchText.startsWith(nr.start.textContent.trim().toLowerCase()) && matchText.endsWith(nr.end.textContent.trim().toLowerCase())) {
      return new Range.NormalizedRange(nr);
    } else {
...
Annotator = (function(_super) {
  ...
  Annotator.prototype.setupAnnotation = function(annotation) {
    ...
    root = this.wrapper[0];
    matchText = this.options.exactMatch ? annotation.quote.toLowerCase() : false;
