...
Annotator.Erratum = (function(_super) {
  ...
  Erratum.prototype._setupComment = function(annotation) {
    var comment, dateString, div, erratum, icon, isoDate, missing, published, quote, replies, reply, self, textString, textarea, userString, userTitle, where, _i, _len;
    self = this;
    ...
    if (controls.length === 0) {
      ...
      if (save_btn) {
        save_btn.bind('click', function() {
          return self.onReplyEntryClick(event, annotation);
        });
      }
      if (cancel_btn) {
        cancel_btn.bind('click', function() {
          return self.onCancelReply(event, annotation);
        });
      }
    }
  ...
  Erratum.prototype.onCancelReply = function(event, annotation) {
    ...
    item.slideUp('fast');
    return item.parent().removeClass('open');
  };
  ...
  Erratum.prototype._reloadComment = function(annotation) {
    var comment, erratum_quote, self;
