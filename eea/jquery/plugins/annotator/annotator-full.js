...
Annotator = (function(_super) {
  ...
  Annotator.prototype.setupAnnotation = function(annotation) {
    var e, matchText, normed, normedRanges, r, root, _i, _j, _len, _len1, _ref;
    root = this.wrapper[0];
...
Annotator.Erratum = (function(_super) {
  ...
  Erratum.prototype._reloadComment = function(annotation) {
    ...
    comment.bind({
      'click': function(evt) {
        var highlight, highlights, i, scrollTop, _i, _len, _results;
        ...
        if (comment.parents('.fullscreen').length) {
          ...
          $('.annotator-hl').removeClass('hover');
          _results = [];
          for (i = _i = 0, _len = highlights.length; _i < _len; i = ++_i) {
            ...
            _results.push($(highlight).addClass('hover'));
          }
          return _results;
        }
      }
