...
Annotator.Erratum = (function(_super) {
  ...
  Erratum.prototype._setupComment = function(annotation) {
    var comment, dateString, div, erratum, missing, published, quote, replies, reply, self, textString, userString, userTitle, where, _i, _len;
    self = this;
