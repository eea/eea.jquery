...
Annotator.Plugin.Comment = (function(_super) {
  ...
  Comment.prototype.addReplyButton = function(viewer, annotations) {
    var dateString, div, idx, isoDate, item, listing, published, replies, reply, replylist, username, usertitle, _i, _j, _len, _len1;
...
Annotator.Erratum = (function(_super) {
  ...
  Erratum.prototype._setupComment = function(annotation) {
    var comment, dateString, div, erratum, icon, isoDate, missing, published, quote, replies, reply, self, textString, userString, userTitle, where, _i, _len;
    self = this;
