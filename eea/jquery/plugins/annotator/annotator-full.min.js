...
Annotator.Plugin.Comment = (function(_super) {
  ...
  Comment.prototype.addReplyButton = function(viewer, annotations) {
    var ann, annotator_listing, i, l, replies, reply, replylist, sorted, unsorted, _i, _j, _k, _len, _len1, _len2, _ref, _ref1;
    ...
    for (i = _i = 0, _len = annotator_listing.length; _i < _len; i = ++_i) {
      ...
      l = $(l);
      replies = [];
      unsorted = this.annotator.dumpAnnotations();
  ...
  Comment.prototype.onReplyEntryClick = function(event) {
    ...
    if (reply !== '') {
      ...
      if (this.annotator.plugins.Permissions && this.annotator.plugins.Permissions.user) {
      ...
      new_annotation = this.annotator.setupAnnotation(new_annotation);
  ...
  Comment.prototype.deleteReply = function(event) {
    var ann, parent_id, reply_item, reply_text, _i, _len, _ref, _results;
    ...
    _ref = this.annotator.dumpAnnotations();
    _results = [];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ann = _ref[_i];
      if (ann.parent === parent_id) {
        if (ann.reply.reply === reply_text) {
          ann.highlights = [];
          this.annotator.deleteAnnotation(ann);
